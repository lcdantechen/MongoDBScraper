...
app.get('/scrape', function(req, res) {
  ...
  request('http://www.fromupnorth.com/illustration-inspiration-1264/', function(error, response, html) {
  	// then, we load that into cheerio and save it to $ for a shorthand selector
    var $ = cheerio.load(html);
   
  /*  console.log('TEST!!!!!!***************', $('.small-archive-items .small-archive-item'));*/
    // now, we grab every h2 within an article tag, and do the following:
    $('.centeredContent a').each(function(i, element) {
